...
struct randSpgInput {
  ...
  randSpgInput(uint _spg, const std::vector<uint>& _atoms,
	       ...
	       double minRR, double Vmin, double Vmax, uint MaxA, const std::vector<std::pair<std::pair<uint, uint>, double>>& distance_constraint, bool forceW) :
                   spg(_spg),
                   atoms(_atoms),
                   latticeMins(_lmins),
                   ...
                   minRadius(minRR),
                   customMinIADs(distance_constraint),
                   ...
                   verbosity('n'),
                   maxAttempts(MaxA),
                   forceMostGeneralWyckPos(forceW) {}

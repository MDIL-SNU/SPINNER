...
num_of_total_structure = len(breadlines)-1
...
os.chdir("dft")
shutil.copytree(src_path+'/amp2_normal', 'src')
shutil.copytree(src_path+'/amp2_normal0','src0')
...
num_sample = min(num_of_total_structure-N_high, num_sample)

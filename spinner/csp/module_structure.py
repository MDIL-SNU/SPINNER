...
from spinner.csp.module_crossover import *
...
def random_gen(Vmin, inp_file, atomnumlist, atomnamelist, tolerance_matrix, filename, gen, pop):
    ...
    while 1:
        ...
        pymin = pyrandspg.LatticeStruct(lmin, lmin, lmin, 40.0, 40.0, 40.0)
        pymax = pyrandspg.LatticeStruct(lmax, lmax, lmax, 140.0, 140.0, 140.0)

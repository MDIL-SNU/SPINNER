...
from spinner.csp.module_rdf import *
import time
import spinner.csp.module_lammps
from spinner.csp.module_lammps import *
import math

def core_job(gen, rank, pop, parent, struct_type,Vmin, inp_file, output_path, atomnamelist, atomnumlist, parent_data, continue_, Emin, tolerance_matrix, average_atom_e, startnum):
